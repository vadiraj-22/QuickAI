    ...
    <div id="features" className='w-full px-4 sm:px-6 md:max-w-[90%] lg:max-w-[85%] xl:max-w-[80%] mx-auto my-24'>
      ...
      <div className='flex flex-wrap mt-10 justify-center'>
        {AiToolsData.map((tool,index)=>(
            <div key={index} className='p-8 m-4 max-w-xs rounded-lg shadow-lg border hover:-translate-y-1 transition-all duration-300 cursor-pointer' 
                 style={{
                ...
                <tool.Icon className='w-12 h-12 p-3 text-[var(--primary-foreground)] rounded-xl' style={{background: `linear-gradient(to bottom, ${tool.bg.from} , ${tool.bg.to})`}}/>
